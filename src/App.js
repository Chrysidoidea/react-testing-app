import CharityElementsComponent from "./components/charity-elements-object/charity-elements.component";
import CharityElementsConstructorComponent from "./components/charity-elements-constructor/charity-elements-constructor.component";

const App = () => {
//array with objects which will used for rendering our app's elements
...
//array with objects which will used for rendering our apps elements

  return (

//generating elements trough .map() using categories array, title, info and id props

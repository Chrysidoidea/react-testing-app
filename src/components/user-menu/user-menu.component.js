        ...
        <AnimationComponent>
            <div className="user-menu-container">
                <div className="user-menu">
                    <h2 className='header-text'>Greetings {userName}.</h2>
                    <h2 className='header-text'>You have registered in my "Hello World" project</h2>
                    <h3 className='header-text'>As reward, you can read this little science-fiction story.</h3>
                    <h3 className='header-text'>Hope you will like it.</h3>
...
In the end, Amelia's story is not just about her love for science; it is a story about hope, determination, and the incredible potential that lies within each of us. It is a story that reminds us that, through science, we can shape our destiny and create a brighter, more sustainable future for all.
                    ...
                    <span className='author'>An Anonymous Author</span>
                    <SignOutButton/>
